...
/* A través de los puertos GPIO se puede realizar una conversión analógico-digital, por lo tanto es posible 
tomar un valor de voltaje entre 0 y 3,3v y mapearlo con una resolución de 12 bits para convertirlo en un 
